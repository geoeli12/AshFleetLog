...
import dailyOrders from "./routes/dailyOrders.js";
import pickupOrders from "./routes/pickupOrders.js";
...
app.use("/api/daily-orders", dailyOrders);
app.use("/api/pickup-orders", pickupOrders);
